...
if __name__ == "__main__":
    ...
    gene_name_350 = csv.DictReader(open('C:/STUDIES/RESEARCH/phoenix/all_manuscript_models/gene_names_350.csv', 'r'))
    gene_name_list_350 = []
    for line in gene_name_350:
        gene_name_list_350.append(line)
    
    dir_350 = 'C:/STUDIES/RESEARCH/phoenix/ground_truth_simulator/clean_data/G350_150samples.csv'
    dir_690 = 'C:/STUDIES/RESEARCH/phoenix/ground_truth_simulator/clean_data/G690_150samples.csv'
